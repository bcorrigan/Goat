...
public class ImageSearcher extends AbstractSearcher<ImageSearchResult> {
    ...
    public String getBaseUrl() {
        return BASE_SEARCH_URL + "images";
    }
    
    public Type getResponseType() {
        return new TypeToken<SearchResponse<goojax.search.ImageSearchResult>>(){}.getType();
    }
